...
const OrderScreen = () => {
    ...
    const [{isPending}, paypalDispath] = usePayPalScriptReducer()
    ...
    useEffect(() => {
        if (!errorPayPal && !loadingPayPal && paypal.clientId) {
            const loadPayPalScript = async () => {
                ...
                paypalDispath({type: 'setLoadingStatus', value: 'pending'})
            }
    ...
    }, [order, paypal, paypalDispath, loadingPayPal, errorPayPal])
